...
ui <- shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      helpText("Analysis of Independent Differences (AID) for analyzing thermal proteome profiling data. For more information, please see Panov, A. & Gygi, S.P. (2019), or online at https://github.com/alex-bio/TPP."),
